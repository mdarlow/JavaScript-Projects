...
function placeXOrO(squareNumber)    {
    ...
    //selectedSquare array to see if it contains the square number
    //clicked on.
    if (!selectedSquares.some(element => element.includes(squareNumber)))   {
        ...
        if (activePlayer === "X")   {
            ...
            select.style.backgroundImage = "url('images/cat1.png')";
            //Active player may only be "X" or "O" so, if not "X" it must be "O"
        } else  {
            //If activePlayer is equal to "O", the o.png is placed in HTML.
            select.style.backgroundImage = "url('images/dog1.png')";
        }
        //squareNumber and activePlayer are concatenated together and added to array.
        selectedSquares.push(squareNumber + activePlayer);
        //This calls a function to chekc for any win conditions.
        checkWinConditions();
        //This condition is for changing the active player.
        if (activePlayer === "X")   {
            //This function plays placement sound for "X".
            //This soundbyte was
            ...
            //This function plays placement sound for "O".
    ...
    function computersTurn()    {
        ...
        while(!success) {
            ...
            //If the random number evaluates returns true, the 
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2)    {
    ...
    let x1 = coordX1,
        //This line indicate4s where the start of a lines y axis is.
        y1 = coordY1,
