...
const Calculator = {
    ...
    Display_Value: "0",
    //This will hold the first operand for any expressions, we set 
    //it to null for now
    First_Operand: null,
...
function Handle_Operator(Next_Operator) {
    ...
    if (First_Operand == null)  {
        ...
        //If operator already exists, property lookup is performed for the 
        //operator in the Perform_Calculation object and the function that 
